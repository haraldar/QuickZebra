...
labelV2.AddText("Intershipping, Inc.");
labelV2.SetFont('0');
...
Console.WriteLine(labelV2.GetLabelString(wrap: true, newlined: true));
labelV2.CallLabelary(labelV2.GetLabelString(wrap: true));
